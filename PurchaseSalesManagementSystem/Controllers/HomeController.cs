...
namespace PurchaseSalesManagementSystem.Controllers
{
    public class HomeController : Controller
    {
            ...
            string reportName)
        {
            ...
            {
                dt.Columns["MonthlyQty2"]!.ColumnName = DateTime.Today.ToString("yyyy-MM");
            }
            ...
            {
                dt.Columns["MonthlyQty4"]!.ColumnName = DateTime.Today.AddMonths(2).ToString("yyyy-MM");
            }
            if (dt.Columns.Contains("MonthlyQty5"))
            {
                dt.Columns["MonthlyQty5"]!.ColumnName = DateTime.Today.AddMonths(3).ToString("yyyy-MM");
            }
            if (dt.Columns.Contains("MonthlyQty6"))
            {
                dt.Columns["MonthlyQty6"]!.ColumnName = DateTime.Today.AddMonths(4).ToString("yyyy-MM");
            }
            if (dt.Columns.Contains("MonthlyQty7"))
            {
                dt.Columns["MonthlyQty7"]!.ColumnName = DateTime.Today.AddMonths(5).ToString("yyyy-MM");
            }
            if (dt.Columns.Contains("MonthlyQty8"))
            {
                dt.Columns["MonthlyQty8"]!.ColumnName = DateTime.Today.AddMonths(6).ToString("yyyy-MM");
            }
            if (dt.Columns.Contains("MonthlyQty9"))
            {
                dt.Columns["MonthlyQty9"]!.ColumnName = DateTime.Today.AddMonths(7).ToString("yyyy-MM");
            }
