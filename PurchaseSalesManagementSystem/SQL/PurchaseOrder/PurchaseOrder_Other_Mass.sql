    ...
    BaseData2 AS (
        SELECT
            ...
            CASE
                ...
                WHEN CustReqDate BETWEEN DATEADD(WEEK, 3, GETDATE()) AND DATEADD(WEEK, 8, GETDATE())  THEN CAST(DATEADD(WEEK, -1, CustReqDate) AS DATE)
                ELSE CAST(DATEADD(WEEK, 7, GETDATE()) AS DATE)
            END AS POReqDate,
            CASE
        ...
        WHERE
            ...
            AND VendorNo NOT IN ('06-0000200','08-0000350','08-0000250','14-0000300','10-0000500','08-0000220','08-0000360')
    )
SELECT
    1 AS Seq,
    'Naimi Hashimoto' AS ConfirmTo,
