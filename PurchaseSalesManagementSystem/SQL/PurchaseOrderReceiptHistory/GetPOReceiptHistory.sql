 SELECT
	...
	TRIM(REPLACE(REPLACE(REPLACE(PO_ReceiptHistoryHeader.InvoiceNo, CHAR(13), ''), CHAR(10), ''), CHAR(9), '')) AS [InvoiceNo],
	...
	TRIM(REPLACE(REPLACE(REPLACE(CASE WHEN PO_ReceiptHistoryDetail.PurchaseOrderNo IS NULL THEN AP_InvoiceHistoryDetail.ItemCodeDesc ELSE PO_ReceiptHistoryDetail.ItemCodeDesc END, CHAR(13), ''), CHAR(10), ''), CHAR(9), '')) AS [ItemDescription],
	...
	TRIM(REPLACE(REPLACE(CASE WHEN PO_ReceiptHistoryDetail.PurchaseOrderNo IS NULL THEN AP_InvoiceHistoryDetail.CommentText ELSE PO_ReceiptHistoryDetail.CommentText END, CHAR(13), ''),CHAR(10), '')) AS [Comment],
