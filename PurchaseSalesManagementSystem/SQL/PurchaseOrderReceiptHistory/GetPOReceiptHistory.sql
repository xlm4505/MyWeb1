 SELECT
	...
	TRIM(REPLACE(REPLACE(PO_ReceiptHistoryHeader.InvoiceNo, CHAR(13), ''),CHAR(10), '')) AS [InvoiceNo],
	...
	TRIM(REPLACE(REPLACE(CASE WHEN PO_ReceiptHistoryDetail.PurchaseOrderNo IS NULL THEN AP_InvoiceHistoryDetail.ItemCodeDesc ELSE PO_ReceiptHistoryDetail.ItemCodeDesc END, CHAR(13), ''),CHAR(10), '')) AS [ItemDescription],
